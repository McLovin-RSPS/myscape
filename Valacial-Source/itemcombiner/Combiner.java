...
public class Combiner {
	...
	public void craftItem(int index) {
		...
		if (firstMatches && secondMatches && thirdMatches && fourthMatches) {
			...
			World.sendMessage("<img=10>@blu@[Item Invention]<img=10>@red@ " + player.getUsername() + " Has just Invented themselves a " + itemToCraft.craftedItem.getDefinition().getName());
		} else {
