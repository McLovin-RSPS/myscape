...
public class MiningData {
	...
	public static final int[] RANDOM_GEMS = {694};
	public static final int[] RANDOM_BOND = {15354};
	...
	public static enum Ores {
		...
		AFK_ROCK(new int[]{2111}, 1, 30, 693, 6, -1),
		...
		PurpleCrystals(new int[]{4926, 4927, 4928,}, 96, 21222, 2381, 7, 20),
