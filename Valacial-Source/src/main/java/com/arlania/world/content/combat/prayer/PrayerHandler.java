		...
		TaskManager.submit(new Task(1, player, true) {
			...
			public void execute() {
				...
				if(player.getRights() == PlayerRights.PLAYER) {
					...
					drainAmount /= 1;
				}if(player.getRights() == PlayerRights.EXTREME_DONATOR || player.getRights() == PlayerRights.DIVINE_DONATOR || player.getRights() == PlayerRights.SPONSOR_DONATOR || player.getRights() == PlayerRights.EXECUTIVE_DONATOR) {
					drainAmount = 0;
				}
