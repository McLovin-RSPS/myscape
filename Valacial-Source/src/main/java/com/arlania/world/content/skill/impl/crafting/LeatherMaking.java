			...
			player.setCurrentTask(new Task(2, player, true) {
				...
				public void execute() {
					...
					if(l == leatherData.LEATHER_BOOTS) {
						player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.CRAFT_A_PAIR_OF_LEATHER_BOOTS, 1);

					} else if(l == leatherData.BLACK_DHIDE_BODY) {
						player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.CRAFT_20_BLACK_DHIDE_BODIES, 1);
