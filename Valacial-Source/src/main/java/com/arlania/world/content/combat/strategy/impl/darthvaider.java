...
public class darthvaider implements CombatStrategy {

	private static final Animation anim = new Animation(1978);
	private static final Animation anim2 = new Animation(1978);
	private static final Animation anim3 = new Animation(1978);
