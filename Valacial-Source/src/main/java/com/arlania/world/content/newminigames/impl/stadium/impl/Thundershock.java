...
public class Thundershock extends PokemonMove {
	...
	public void processAttack() {
		// STEP 1 SEND GFX AND ANIMATIONS HERE
			...
			this.getTarget().performGraphic(new Graphic(433)); // Target Graphic
			this.getTarget().performGraphic(new Graphic(434)); // Target Graphic
			this.getTarget().performGraphic(new Graphic(435)); // Target Graphic
			...
			this.getPokemon().performAnimation(new Animation(1978)); // Self Attack Animation
	...
	public int getMaxDamage() {
		return 250; //SINCE LOW PP WE WILL DO HEAVY HIT
	}
