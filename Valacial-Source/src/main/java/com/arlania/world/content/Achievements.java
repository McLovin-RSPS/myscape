...
public class Achievements {
	...
	public enum AchievementData {
		...
		ENTER_THE_DISCORD(Difficulty.EASY, "Enter The Lottery", 45005, null),
		FILL_WELL_OF_GOODWILL_1M(Difficulty.EASY, "Pour 1Q Into The Well", 45006, null),
		...
		BURN_100_MAGIC_LOGS(Difficulty.MEDIUM, "Burn 100 Magic Logs", 45049, new int[]{6, 100}),
