...
public class Agility {
	...
	public static boolean handleObject(Player p, GameObject object) {
		...
		if(agilityObject != null) {
			...
			p.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.CLIMB_AN_AGILITY_OBSTACLE, 1);
			p.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.CLIMB_50_AGILITY_OBSTACLES, 1);
