...
public class PointsHandler {
	...
	public void setPvmPoints(int donationPoints, boolean add) {
		if(add)
			this.pvmPoints += pvmPoints;
		else
			this.pvmPoints = pvmPoints;
	}
		public void incrementPvmPoints(double amount) {
		this.pvmPoints += amount;
	}
	...
	public void setCommendations(int commendations) {
