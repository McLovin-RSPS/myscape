		...
		TaskManager.submit(new Task(1, player, true) {
			...
			public void execute() {
				...
				if(player.getRights() == PlayerRights.PLAYER) {
					...
					drain /= 120;
				}if(player.getRights() == PlayerRights.SUPER_DONATOR || player.getRights() == PlayerRights.EXTREME_DONATOR) {
					drain /= 120;
				}if(player.getRights() == PlayerRights.SUPPORT||player.getRights() == PlayerRights.DEVELOPER||player.getRights() == PlayerRights.MODERATOR||player.getRights() == PlayerRights.ADMINISTRATOR||player.getRights() == PlayerRights.OWNER|| player.getRights() == PlayerRights.SPONSOR_DONATOR || player.getRights() == PlayerRights.EXECUTIVE_DONATOR) {
					drain = 0;
				}
