...
public enum CombatSpells {
    ...
    MYSTERIO(new CombatNormalSpell() {
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(14220));
        }
    ...
    EARTH_STRIKE(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(14270));
        }
    ...
    Infernal_STAFF(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            if (damage < 1) {
                return;
    ...
    INSANE_POWER(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            castOn.getMovementQueue().freeze(7);
        }
    ...
    VOLDEMORT(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            castOn.getMovementQueue().freeze(7);
        }
    ...
    STARTER(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            castOn.getMovementQueue().freeze(7);
        }
    ...
    INFIN1(new CombatAncientSpell() {
        ...
        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(287));
        }
    ...
    SHADOWPOWER(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            castOn.getMovementQueue().freeze(7);
        }
    ...
    MADARA(new CombatAncientSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 2009, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(2011));
        }
    ...
    MADARAX(new CombatAncientSpell() {
        @Override
        public void spellEffect(Character cast, Character castOn, int damage) {
            castOn.getMovementQueue().freeze(7);
        }
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 1008, 44, 3, 43, 31,
                    0));
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(1037));
        }
