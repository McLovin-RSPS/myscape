...
public class WildyWyrmChest {
	...
	public static void handleChest(final Player p, final GameObject chest) {
		...
		if (p.getRights() == PlayerRights.SPONSOR_DONATOR  || p.getRights() == PlayerRights.ADMINISTRATOR) {
		...
		if (p.getRights() == PlayerRights.EXECUTIVE_DONATOR || p.getRights() == PlayerRights.DEVELOPER) {
