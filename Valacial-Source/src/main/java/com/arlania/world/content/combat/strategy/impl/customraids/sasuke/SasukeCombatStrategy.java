package com.arlania.world.content.combat.strategy.impl.customraids.sasuke;
 ...
 **/
public class SasukeCombatStrategy implements CombatStrategy {
    ...
    private static final Graphic splashGraphic = new Graphic(1194);
    public static final int MAGIC_PROJECTILE = 1194;
    @Override
