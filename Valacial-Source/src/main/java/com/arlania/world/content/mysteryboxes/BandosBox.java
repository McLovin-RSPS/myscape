...
public class BandosBox {
	...
	public void process() {
		...
		if (player.getInventory().hasItem(new Item(BOX, 1))) {
			...
			int donor[][] = {
					{5023}, //Uncommon, 0
					{14925, 14926, 14927, 14928, 14929, 14930}, //Rare, 1
					{14910, 14911, 14912, 14913, 14914, 14915, 14916, 14917, 14918}
			};
			numGen3 = Math.random();
			...
			if (randomYoda == 0) {
				...
				World.sendMessage("<shad=0>@bla@[@yel@Lucky Block@bla@] [@mag@Legendary@bla@] @yel@" + player.getUsername() + "@bla@ Has just received a @yel@ " + ItemDefinition.forId(donor[rewardGrade3][rewardPos]).getName() + " @bla@!");
				...
				if (randomDouble == 0) {
					...
					player.setAnimation(new Animation(6382));
					player.setGraphic(new Graphic(127));
					World.sendMessage("<shad=0>@bla@[@yel@Lucky Block@bla@] [@blu@Uncommon@bla@] @yel@" + player.getUsername() + "@bla@ Has just received a @yel@ " + ItemDefinition.forId(donor[rewardGrade3][rewardPos]).getName() + " @bla@!");
					double randomDouble = Misc.random(125);
				...
				player.setAnimation(new Animation(6382));
				player.setGraphic(new Graphic(127));
				World.sendMessage("<shad=0>@bla@[@yel@Lucky Block@bla@] [@gre@common@bla@] @yel@" + player.getUsername() + "@bla@ Has just received a @yel@ " + ItemDefinition.forId(donor[rewardGrade3][rewardPos]).getName() + " @bla@!");
				double randomDouble = Misc.random(125);
				...
				if (randomDouble == 0) {
					...
					player.getInventory().delete(14933, 1);
