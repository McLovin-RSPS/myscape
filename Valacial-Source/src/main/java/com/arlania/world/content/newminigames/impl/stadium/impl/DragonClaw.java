...
public class DragonClaw extends PokemonMove {
	...
	public void processAttack() {
		// STEP 1 SEND GFX AND ANIMATIONS HERE
			...
			this.getTarget().performGraphic(new Graphic(441)); // Target Graphic
			...
			this.getPokemon().performAnimation(new Animation(10961)); // Self Attack Animation
