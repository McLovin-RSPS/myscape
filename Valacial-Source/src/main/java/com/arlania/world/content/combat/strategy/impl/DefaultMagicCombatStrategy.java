	...
	public CombatContainer attack(Character entity, Character victim) {
		...
		if (entity.isPlayer()) {
			...
			case 174:
				...
				break;
//				case 6102:
//					npc.prepareSpell(RandomUtility.randomElement(new CombatSpells[] {  CombatSpells.OBLIVION2 }).getSpell(), victim);
//					break;
				case 2505:
					npc.prepareSpell(RandomUtility.randomElement(new CombatSpells[] {  CombatSpells.DRSTRANGE }).getSpell(), victim);
			...
			case 13454:
				...
				break;
				case 2511:
					npc.prepareSpell(CombatSpells.SPIDERMAN.getSpell(),victim);
					break;
			case 13453:
			...
			case 2896:
				...
				break;
				case 4419:
				npc.prepareSpell(CombatSpells.ALIEN.getSpell(), victim);
				break;
			case 2882:
			...
			case 6221:
				...
				break;
                case 2509:
                    npc.prepareSpell(CombatSpells.IRONMAN.getSpell(), victim);
                    break;
