...
public class ClanChatManager {
	...
	public static void sendMessage(Player player, String message) {
		...
		for (Player memberPlayer : clan.getMembers()) {
			if (memberPlayer != null) {
				...
				String toSend = "@clan:A@" + bracketColor + "[" + clanNameColor + clan.getName() + bracketColor + "]" + nameColor + ""+rankImg+"" +
				...
				memberPlayer.getPacketSender().sendMessage(toSend);
			}
		}
	}
	...
	public static void handleLogin(Player player) {
		...
		if(player.getClanChatName() == null || player.getClanChatName().equals("help")) {
