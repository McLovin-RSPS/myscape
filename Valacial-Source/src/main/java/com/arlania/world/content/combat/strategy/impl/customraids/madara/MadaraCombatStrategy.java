package com.arlania.world.content.combat.strategy.impl.customraids.madara;
 ...
 **/
public class MadaraCombatStrategy implements CombatStrategy {

    private static final Animation attackAnimation = new Animation(11978);
    private static final Graphic splashGraphic = new Graphic(78);
    public static final int MAGIC_PROJECTILE = 88;
    @Override
    ...
    /**
     * Handles the phase two initial attack
     */
    public void phaseTwoInitAttack(){

    }
    /**
     * Handles the phase three initial attack
     */
