...
public class Incinerate extends PokemonMove {
	...
	public void processAttack() {
		...
		//STEP 1- SEND SPELL
					...
					this.getTarget().performGraphic(new Graphic(453)); // Target Graphic
					this.getTarget().performAnimation(new Animation(435)); // Target Recoil Animation
					// GFX AND ANIMATION  ON PLAYERS POKEMON //
					this.getPokemon().performGraphic(new Graphic(1950)); // Self Graphic
					this.getPokemon().performAnimation(new Animation(435)); // Self Attack Animation
	...
	public int getMaxDamage() {
		return 550; //SINCE LOW PP WE WILL DO HEAVY HIT//
	}
