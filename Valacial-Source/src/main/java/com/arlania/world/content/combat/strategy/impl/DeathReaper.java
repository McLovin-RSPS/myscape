...
public class DeathReaper implements CombatStrategy {

	private static final Animation anim = new Animation(421);
	private static final Animation anim2 = new Animation(642);
	private static final Animation anim3 = new Animation(6394);
	private static final Graphic gfx1 = new Graphic(379, 3, GraphicHeight.MIDDLE);
	private static final Graphic gfx2 = new Graphic(381);
