...
public class DefaultRangedCombatStrategy implements CombatStrategy {
    ...
    public static void decrementAmmo(Player player, Position pos) {
        ...
        int[] buggedGuns = {423, 4786, 601,20605, 20695,894, 21044, 20705,21082,5202, 13733,937,14923,5138,940,4640,939,20643,700,701,895,896,21077,20645,2867,21080, 21079,422};
