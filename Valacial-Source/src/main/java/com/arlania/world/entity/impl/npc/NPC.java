...
import com.arlania.world.entity.impl.npc.click_type.NpcClickType;
...
public class NPC extends Character {
	...
	public void sequence() {
		...
		if(constitution < defaultConstitution) {
			if(!isDying) {
				if(getLastCombat().elapsed((id == 13447 || id == 3200 ? 50000 : 5000)) && !getCombatBuilder().isAttacking() && getLocation() != Location.PEST_CONTROL_GAME && getLocation() != Location.RAID) {
