...
public abstract class ItemContainer {
	...
	/**
	 * ItemContainer constructor to reincarnate a new instance and to define the player.
	...
	public ItemContainer delete(Item item, int slot, boolean refresh, ItemContainer toContainer) {
		if (item == null || slot < 0)
			return this;
		boolean leavePlaceHolder = (this instanceof Shop && this.allowZeroAmount()) || (getPlayer().getBankSearchingAttribtues().isSearchingBank() || toContainer instanceof Inventory) && this instanceof Bank
