...
import com.arlania.net.packet.impl.PriceGuideListener;
import com.arlania.net.packet.impl.PvmInterfaceHandler;
...
//import com.arlania.command.nullsystem.CommandHandler;
...
public class PacketConstants {
	...
	static {
		...
		PACKETS[PvmInterfaceHandler.OPCODE] = new PvmInterfaceHandler();
...
//		PACKETS[GambleInvititationPacketListener.CHATBOX_GAMBLE_OPCODE] = new GambleInvititationPacketListener();
		...
		PACKETS[125] = new PriceGuideListener();
